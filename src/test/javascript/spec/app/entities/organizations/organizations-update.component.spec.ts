...
import { OrganizationsUpdateComponent } from 'app/entities/organizations/organizations-update.component';
...
describe('Component Tests', () => {
  describe('Organizations Management Update Component', () => {
    let comp: OrganizationsUpdateComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(OrganizationsUpdateComponent, '')
        .compileComponents();
