...
/**
 * REST controller for managing {@link com.jhipster.reval.ui.domain.Providers}.
 */
@RestController
@RequestMapping("/api")
public class ProvidersResource {
    ...
    public ProvidersResource(ProvidersService providersService) {
    ...
    public ResponseEntity<Providers> createProviders(@Valid @RequestBody Providers providers) throws URISyntaxException {
        ...
        Providers result = providersService.save(providers);
    ...
    public ResponseEntity<Providers> updateProviders(@Valid @RequestBody Providers providers) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, providers.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Providers> getProviders(@PathVariable Long id) {
        ...
        Optional<Providers> providers = providersService.findOne(id);
