package com.jhipster.reval.ui.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("reval");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("reval");
        ...
        config.getMapConfigs().put("com.jhipster.reval.ui.domain.*", initializeDomainMapConfig(jHipsterProperties));
